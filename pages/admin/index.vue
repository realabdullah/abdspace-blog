...
const studioConfigured = Boolean(config.public.studioConfigured);
...
<template>
	<main v-if="!studioConfigured" class="mx-auto flex min-h-screen max-w-xl items-center px-6 py-16">
		<div>
			...
			<p class="text-base leading-7 text-ink/65 dark:text-paper/65">Set the GitHub OAuth variables on the production deployment, then redeploy the blog.</p>
		</div>
	</main>
</template>
